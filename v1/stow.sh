#!/usr/bin/env sh
# Minimal GNU Stow runner for v1 dotfiles with safe backups (POSIX sh)
# - No arguments
# - Always targets $HOME
# - Packages: backgrounds, hyprland, hypridle hyprlock hyprmocha hyprpaper scripts waybar wofi
...
packages="backgrounds hyprland hypridle hyprlock hyprmocha hyprpaper scripts waybar wofi networkmanager-dmenu swaync"
